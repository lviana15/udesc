...
public class SistemaPetShop {
    ...
    public void cadastrarVeterinario(String nome, float salario) {
    ...
    public void cadastrarAnimal() {
    	...
    	veterinarios[idCadastro].setAnimais(animais);
    	veterinarios[idCadastro].setQuantidadeAnimais(indexAnimal++);
    }
    ...
    public Animal[] mostrarAnimais() {
    	...
    	int length = veterinarios[idVet].getQuantidadeAnimais();
